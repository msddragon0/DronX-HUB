...
-- ====== TODAS AS ILHAS DO BLOX FRUITS ======
local ilhas = {
    -- ============ FIRST SEA ============
    {nome = "⚓ Windmill Village (1st)", pos = CFrame.new(979, 16, 1429)},
    {nome = "⚓ Marine Fort (1st)", pos = CFrame.new(-2566, 6, 2045)},
    {nome = "⚓ Middle Town (1st)", pos = CFrame.new(-690, 15, 1582)},
    {nome = "⚓ Jungle (1st)", pos = CFrame.new(-1612, 36, 149)},
    {nome = "⚓ Pirate Village (1st)", pos = CFrame.new(-1181, 4, 3803)},
    {nome = "⚓ Desert (1st)", pos = CFrame.new(944, 20, 4373)},
    {nome = "⚓ Snow Island (1st)", pos = CFrame.new(1347, 104, -1319)},
    {nome = "⚓ MarineFord (1st)", pos = CFrame.new(-4914, 50, 4281)},
    {nome = "⚓ Colosseum (1st)", pos = CFrame.new(-1427, 7, -2792)},
    {nome = "⚓ Sky Island 1 (1st)", pos = CFrame.new(-4869, 733, -2667)},
    {nome = "⚓ Sky Island 2 (1st)", pos = CFrame.new(-7859, 5544, -381)},
    {nome = "⚓ Sky Island 3 (1st)", pos = CFrame.new(-7894, 5547, -380)},
    {nome = "⚓ Prison (1st)", pos = CFrame.new(4875, 5, 734)},
    {nome = "⚓ Magma Village (1st)", pos = CFrame.new(-5247, 12, 8504)},
    {nome = "⚓ Underwater (1st)", pos = CFrame.new(61163, 11, 1819)},
    {nome = "⚓ Fountain City (1st)", pos = CFrame.new(5127, 59, 4105)},
    {nome = "⚓ Shanks Room (1st)", pos = CFrame.new(-1442, 29, -28)},
    {nome = "⚓ Mob Island (1st)", pos = CFrame.new(-2850, 7, 5354)},
    
    -- ============ SECOND SEA ============
    {nome = "🌊 Cafe (2nd)", pos = CFrame.new(-380, 77, 255)},
    {nome = "🌊 First Spot (2nd)", pos = CFrame.new(-11, 29, 2771)},
    {nome = "🌊 Dark Area (2nd)", pos = CFrame.new(3780, 22, -3498)},
    {nome = "🌊 Flamingo Mansion (2nd)", pos = CFrame.new(-281, 306, 609)},
    {nome = "🌊 Flamingo Room (2nd)", pos = CFrame.new(2284, 15, 905)},
    {nome = "🌊 Green Zone (2nd)", pos = CFrame.new(-2448, 73, -3210)},
    {nome = "🌊 Factory (2nd)", pos = CFrame.new(424, 211, -427)},
    {nome = "🌊 Colosseum (2nd)", pos = CFrame.new(-1503, 219, 1369)},
    {nome = "🌊 Zombie Island (2nd)", pos = CFrame.new(-5622, 492, -781)},
    {nome = "🌊 Snow Mountain (2nd)", pos = CFrame.new(753, 408, -5274)},
    {nome = "🌊 Punk Hazard (2nd)", pos = CFrame.new(-6127, 15, -5040)},
    {nome = "🌊 Cursed Ship (2nd)", pos = CFrame.new(923, 125, 32885)},
    {nome = "🌊 Ice Castle (2nd)", pos = CFrame.new(6148, 294, -6741)},
    {nome = "🌊 Forgotten Island (2nd)", pos = CFrame.new(-3032, 317, -10075)},
    {nome = "🌊 Usopp Island (2nd)", pos = CFrame.new(4816, 8, 2863)},
    {nome = "🌊 Mini Sky Island (2nd)", pos = CFrame.new(-288, 49326, -35248)},
    
    -- ============ THIRD SEA ============
    {nome = "🔥 Port Town (3rd)", pos = CFrame.new(-290, 6, 5343)},
    {nome = "🔥 Hydra Island (3rd)", pos = CFrame.new(5753, 610, -282)},
    {nome = "🔥 Great Tree (3rd)", pos = CFrame.new(2681, 1682, -7190)},
    {nome = "🔥 Castle on the Sea (3rd)", pos = CFrame.new(-5075, 314, -3150)},
    {nome = "🔥 Floating Turtle (3rd)", pos = CFrame.new(-13274, 531, -7579)},
    {nome = "🔥 Haunted Castle (3rd)", pos = CFrame.new(-9515, 164, 5786)},
    {nome = "🔥 Ice Cream Island (3rd)", pos = CFrame.new(-902, 79, -10988)},
    {nome = "🔥 Peanut Island (3rd)", pos = CFrame.new(-2062, 50, -10232)},
    {nome = "🔥 Cake Island (3rd)", pos = CFrame.new(-1884, 19, -11666)},
    {nome = "🔥 Cocoa Island (3rd)", pos = CFrame.new(87, 73, -12319)},
    {nome = "🔥 Candy Island (3rd)", pos = CFrame.new(-1014, 149, -14555)},
    {nome = "🔥 Tiki Outpost (3rd)", pos = CFrame.new(-16542, 55, 1044)},
    {nome = "🔥 Mansion (3rd)", pos = CFrame.new(-12468, 375, -7554)},
    {nome = "🔥 MiniSky (3rd)", pos = CFrame.new(-260, 49325, -35253)},
    {nome = "🔥 Castle on the Sea 2 (3rd)", pos = CFrame.new(-5075, 314, -3150)},
    {nome = "🔥 Sea of Treats (3rd)", pos = CFrame.new(300, 30, 4000)},
    {nome = "🔥 Jungle Island (3rd)", pos = CFrame.new(-12267, 459, -10277)},
    {nome = "🔥 Pirate Island (3rd)", pos = CFrame.new(-435, 189, 5551)},
    {nome = "🔥 Marine Fort (3rd)", pos = CFrame.new(2198, 128, -7109)},
    {nome = "🔥 Deep Forest (3rd)", pos = CFrame.new(-13232, 332, -7626)},
    {nome = "🔥 Nut Island (3rd)", pos = CFrame.new(-2105, 37, -10195)},
    {nome = "🔥 Choco Island (3rd)", pos = CFrame.new(231, 23, -12200)},
    {nome = "🔥 Sea of Hope (3rd)", pos = CFrame.new(1547, 14, 4381)},
}
