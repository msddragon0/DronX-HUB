-- ============================================================
-- DRONX – Auto Farm v1.0
-- Base para adicionar Auto Mastery, Auto Chest e outros
-- ============================================================

print("[DRONX] Carregando Auto Farm...")
...
local function criarGUI()
    ...
    -- Botão para abrir/fechar (quadrado)
...
pcall(criarGUI)
print("[DRONX] Auto Farm v1.0 carregado. Clique no quadrado ▶ para abrir.")
